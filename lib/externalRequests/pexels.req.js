...
const getRandomForecastImage = ({ forecast }) => {
  // NOTE Removed if statement until later: lack of information on what
  // possible weather summaries exist from DarkSky make this API
  // bounce requests on the frontend a lot :/ FIX LATER!
